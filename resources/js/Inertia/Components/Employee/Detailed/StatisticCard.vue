...
<template>
    <div class="pb-[60px] lg:min-h-[calc(100dvh-9rem)] flex flex-col items-center justify-center">
        <div class="flex items-start justify-start w-full h-full pb-8  mb-8">
            <Button to="/" variant="ghost" label="back to homepage" icon="i-ph-arrow-left-thin" color="gray" class="transition-colors duration-200" />
        </div>
            ...
            <div class="card-border relative z-40 md:col-span-2 h-full md:h-[400px] lg:h-full lg:col-span-1 lg:row-span-2 bg-gray-800 p-[1px] rounded-xl">
                <div class="profile-card flex flex-col md:flex-row lg:flex-col items-center justify-between h-full z-40 !bg-gray-950 rounded-[9.5px] relative p-[18px] sm:p-[44px]">
                    <div class="flex flex-col md:flex-row lg:flex-col gap-y-2 pb-2 md:w-full items-center text-center justify-between">
                        <Avatar  image="https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp" shape="circle" class="rounded-full w-40" size="xlarge" />
                        <div class="flex flex-col items-center gap-4">
                            <div class="flex flex-col gap-y-[18px]">
<!--                                <Button :to="`https://github.com/${contributor.username}`" color="black" variant="ghost" size="lg" icon="i-simple-icons-github" target="_blank" :trailing="true" class="transition-colors duration-200">-->
...
<!--                                </Button>-->
                                ...
                                <div class="flex flex-col gap-y-2">
                                    ...
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <span class="text-xl text-center md:text-left lg:text-center md:ml-4 lg:ml-0"><span class="text-2xl font-medium">4000</span>{{"pts"}}</span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="border-primary-400 issues-card card">
                <span class="text-5xl font-medium">5</span>
                <span class="text-2xl">Reactions</span>
            </div>
            <div class="border-blue-400 comments-card card">
                <span class="text-5xl font-medium">20</span>
                <span class="text-2xl">Commended By Someone</span>
            </div>
            <div class="border-violet-400 pull-requests-card card">
                <span class="text-5xl font-medium">4000</span>
                <span class="text-2xl">Total Points Collected</span>
            </div>
            <div class="border-yellow-400 reactions-card card">
                <span class="text-5xl font-medium">1</span>
                <span class="text-2xl">Been Part of Top Board</span>
            </div>
        </div>
    </div>
</template>
...
.profile-card {
    background-image: url('https://nuxters.nuxt.com/card-gradient-bg.svg') ;
...
.issues-card {
    background-image: linear-gradient(180deg, rgba(0, 220, 130, 0.40) 0%, rgba(0, 220, 130, 0.00) 100%, rgba(2, 4, 32, 0.50)), url('https://nuxters.nuxt.com/issues-card-bg.svg');
}

.comments-card {
    background-image: linear-gradient(180deg, rgba(64, 187, 255, 0.40) 0%, rgba(64, 187, 255, 0.00) 100%, rgba(2, 4, 32, 0.50)), url('https://nuxters.nuxt.com/comments-card-bg.svg');
}

.pull-requests-card {
    background-image: linear-gradient(180deg, rgba(139, 92, 246, 0.40) 0%, rgba(139, 92, 246, 0.00) 100%, rgba(2, 4, 32, 0.50)), url('https://nuxters.nuxt.com/pull-requests-card-bg.svg');
}

.reactions-card {
    background-image: linear-gradient(180deg, rgba(247, 209, 76, 0.40) 0%, rgba(247, 209, 76, 0.00) 100%, rgba(2, 4, 32, 0.50)), url('https://nuxters.nuxt.com/reactions-card-bg.webp');
}
